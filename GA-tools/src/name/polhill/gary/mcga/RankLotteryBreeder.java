...
public class RankLotteryBreeder extends KeepBestRankLotteryBreeder {
  ...
  public RankLotteryBreeder(double pCrossover, double pMutate, double pPerturb, double perturbVar) {
  	this(pCrossover, pMutate, pPerturb, perturbVar, 0);
  }
  
  private RankLotteryBreeder(double pCrossover, double pMutate, double pPerturb, double perturbVar, int nBest) {
  	super(pCrossover, pMutate, pPerturb, perturbVar, nBest);
  }
